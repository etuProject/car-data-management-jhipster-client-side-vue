...
export default class TripComponentsPage extends AlertPage {
...
export class TripDeleteDialog {
  ...
  title: ElementFinder = element(by.id('clientApp.trip.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-trip'));
}
