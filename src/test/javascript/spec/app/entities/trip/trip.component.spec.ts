...
import TripComponent from '@/entities/trip/trip.vue';
import TripClass from '@/entities/trip/trip.component';
...
describe('Component Tests', () => {
  describe('Trip Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TripClass>(TripComponent, {
        store,
        i18n,
        localVue,
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(tripServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(tripServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(tripServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
