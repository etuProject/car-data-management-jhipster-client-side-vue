...
import TripUpdateComponent from '@/entities/trip/trip-update.vue';
import TripClass from '@/entities/trip/trip-update.component';
...
describe('Component Tests', () => {
  describe('Trip Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TripClass>(TripUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.trip = entity;
        tripServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(tripServiceStub.update.calledWith(entity)).toBeTruthy();
